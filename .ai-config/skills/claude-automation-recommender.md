...
description: >
  ...
  Trigger: automation recommendations, optimize Claude Code, setup Claude Code, improve workflows, MCP servers, hooks
tools:
  - Read
  - Glob
  - Grep
...
metadata:
  ...
  version: "2.0"
  tags: [claude-code, automation, mcp, hooks, skills, plugins]
  updated: "2026-02"
---
